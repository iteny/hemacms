...
$.fn.progressbar.defaults={width:"auto",height:36,value:0,text:"{value}%",onChange:function(_1ed,_1ee){
}};
})(jQuery);
(function($){
function init(_1ef){
...
$(this)._outerHeight(opts.itemHeight+10);
$(this).find(".menu-text").css({height:(opts.itemHeight+10)+"px",lineHeight:(opts.itemHeight+10)+"px"});
});
...
$(this).tooltip("tip").css({color:"#fff",borderColor:"#d43f3a",backgroundColor:"#d9534f"});
},onHide:function(){
$(this).tooltip("destroy");
